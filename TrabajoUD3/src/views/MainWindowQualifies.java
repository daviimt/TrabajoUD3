...
public class MainWindowQualifies extends JFrame {
	...
	public MainWindowQualifies() {
		super("Modify qualifies");
		inicializate(MainWindowQualifies.this);
		...
		jbdelete.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (table.getSelectedRow() < 0) {
					...
					int option = JOptionPane.showOptionDialog(MainWindowQualifies.this, "Are you sure?", "Confirm",
